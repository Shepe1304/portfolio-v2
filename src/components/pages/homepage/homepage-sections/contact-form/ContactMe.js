      ...
      <div className="contactMe--contents">
        <div className="contactMe--statement">
          <div className="contactMe--statement_text">
            I love creativity and am always striving for improvement. As a fast
            learner, you can entrust me with a task and expect my utmost efforts
            in order to complete it.
          </div>
          <div className="contactMe--statement_text" style={{fontWeight: "bold", color: "rgb(245, 232, 155)"}}>
          ...
          <div className="contactMe--contacts">
            <div className="contactMe--contact_container">
              <img src={envelope} alt="" className="contactMe--contact_icon" />
